...
- remove FCM from the list of available notification services
- only release the arm64-v8a ABI variant for modern devices
...
This fork checks for new Molly releases every 6 hours. If it finds a new release it automatically applies Polly customizations on top and force-pushes to main. If the workflow fails, manual intervention is required.
