...
- raising the SDK minimum to Android 12 (API 31) for security and to eliminate legacy code paths
...
- Raising the minimum SDK to Android 12 helps remove legacy compatibility code from the upstream Signal codebase.
